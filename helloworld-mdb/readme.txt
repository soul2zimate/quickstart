...
3 add the external-jms-queue and external-jms-topic
/subsystem=messaging-activemq/external-jms-queue=testQueue:add(entries=[java:/queue/testQueue], enable-amq1-prefix=false)
/subsystem=messaging-activemq/external-jms-topic==testTopic:add(entries=[java:/topic/testTopic], enable-amq1-prefix=false)

4 Deploy the quickstart example
